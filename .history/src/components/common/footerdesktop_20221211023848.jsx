                ...
                <div className='footer-menu'>
                    ...
                    <Row>
                        <Col lg={4} md={4} sm={2} xs={1} >
                            ...
                            <a className='footer-btn'><i className="fab fa-facebook"></i></a>
                            <a className='footer-btn'><i className="fab fa-instagram"></i></a>
                            <a className='footer-btn'><i className="fab fa-twitter"></i></a>
                        </Col>
